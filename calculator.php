<!DOCTYPE html><?php // A Simple Calculator By Junaid Jagirani ^_^ ?>
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		<title>Jagirani Calculator</title>
		<meta name="author" content="Junaid Jagirani." />
		<style>
			body {
	...
	<body>
		...
		<div class="footer">
			<footer>
				<hr>
					<font>Developed By 
						<a href="https://www.google.com/search?q=Junaid Jagirani" target="_blank">Junaid Jagirani</a>
					</font>
				<hr>
			</footer>
<!--  Give a Visit :D  -->
